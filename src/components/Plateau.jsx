...
export default class Plateau extends React.Component {
  ...
  render() {
    return (
      <section id="plateau">
        {this.state.squares.map((e, i) => (<Square key={i} selected={e.selected} roque={e.roque} glow={e.glow} echec={e.echec} attacked={e.attacked} location={e.location} color={e.color} game={this.props.game} />))}
      </section>
    )
  }
}
